...
<div class="card card-outline card-primary">
    ...
    @empty($penjualanDetail)
        ...
        <a href="{{ url('detail_penjualan') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
    @else
        <form method="POST" action="{{ url('/detail_penjualan/'.$penjualanDetail->detail_id) }}" class="form-horizontal">
        @csrf
        {!! method_field('PUT') !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-11">
                ...
                <a class="btn btn-sm btn-default ml-1" href="{{ url('detail_penjualan') }}">Kembali</a>
            </div>
        </div>
        </form>
        @endempty
